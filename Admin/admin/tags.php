<?php 
	...
	{   
		...
		{
			$delete="DELETE FROM tags WHERE `tag_id`='$id'" ;
			$conn->query($delete);
		}
	}
?>
							        ...
							        <?php
											...
											if($result->num_rows >0)
											{
												while($row = $result->fetch_assoc())
												{
													...
													echo "<td>".$row['tag_id']."</td><td>".$row['name']."</td>";
													echo "<td>";
													echo "<a href='tags.php?action=edit&id=".$row['tag_id']."' title='Edit'><img src='resources/images/icons/pencil.png' alt='Edit' /></a>";
													echo '<a href="tags.php?action=delete&id='.$row['tag_id'].'" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a>';
